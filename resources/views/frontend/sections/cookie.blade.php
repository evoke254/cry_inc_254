@php
    $cookie = $__website_sections->where('key','site_cookie')->first();
...
<div class="cookie-main-wrapper">
    <div class="cookie-content">
        ...
        <p class="text-white">{{ __(strip_tags(@$cookie->value->desc)) }} <a href="{{ url('/') . '/' . ltrim(@$cookie->value->link, '/') }}">{{ __("privacy Policy") }}</a></p>
    </div>
