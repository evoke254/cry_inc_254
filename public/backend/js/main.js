                        ...
                        <div class="col-xxl-12 col-xl-6 col-lg-6 form-group">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form--control rate number-input" value="1" name="">
 ...
 * @returns 
 */
function openDeleteModal(URL,target,message,actionBtnText = "Remove",method = "DELETE", closeBtnText = "Close"){
  if(URL == "" || target == "") {
      return false;
  }
          ...
          content: `<div class="card modal-alert border-0">
                      <div class="card-body">
                          <form method="POST" action="${URL}">
                              ...
                              <div class="foot d-flex align-items-center justify-content-between">
                                  <button type="button" class="modal-close btn btn--info">${closeBtnText}</button>
